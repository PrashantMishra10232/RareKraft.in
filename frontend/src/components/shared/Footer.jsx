        ...
        <div className='sm:flex flex-col md:mx-23 sm:mx-10'>
            <div className='sm:flex flex-row'>
                <div id='1' className='w-full sm:w-1/2 row-span-1'>
                    ...
                    <div>
                        <p className='text-gray-700 p-5 md:w-[550px] sm:w-[350px]'>Chlothzy Fashion brings bold elegance to your wardrobe. From bodycon dresses to chic essentials, we redefine style. Perfect fits, premium fabrics — confidence in every thread. Step into the spotlight with Chlothzy — where fashion speaks.</p>
                    </div>
                </div>

                <div id='2' className='py-8 sm:py-0 mx-4 sm:mx-4 md:ml-55 sm:w-1/2 sm:flex flex-row justify-between row-span-1'>
                    <div id='2.1'>
                        <h1 className='text-2xl font-bold sm:font-semibold mt-4 mb-4 sm:mt-auto'>COMPANY</h1>
                        <ul style={{fontFamily: "Roboto, sans-serif"}} className='text-gray-500 mb-8'>
                    ...
                    <div id='2.2' className='sm:py-0 py-4 '>
                        <div className='flex
                         flex-col items-center'>
                            <h1 className='text-2xl font-bold sm:font-semibold mb-5'>GET IN TOUCH</h1>
                            <div className='flex flex-col items-center'>
                                <p className='text-gray-500'><span className='text-gray-700 font-bold'>Phone:</span>8505835814</p>
                                <p className='text-gray-500'><span className='text-gray-700 font-bold'>Email:</span>contact@chlothzy.shop</p>
                            </div>
